...
```{r Labor Force Map, echo = FALSE, warning = FALSE, message = FALSE, fig.width=5, fig.height=10}
...
```{r Combined Rent and House Plot,echo = FALSE, message=FALSE,warning = FALSE, fig.height=14, fig.width = 7}
library(cowplot)
