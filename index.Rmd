...
# Workers Per Permit by County's Rank in Worker Growth

Shows workers per permit ratio for each county. Counties are ordered from slowest worker growth (left side) to fastest worker growth (right side). Data is from 2009-2019.

```{r Growth Speed, echo = FALSE, warning = FALSE, message = FALSE, fig.width=7, fig.height=7}
