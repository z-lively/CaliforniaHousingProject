...
This is the beginnings of an interactive version of the Labor Force Size to Permits by County map.

```{r test map, echo = FALSE, include = TRUE, message = FALSE, warning = FALSE}

pal <- colorNumeric(
  palette = rev(cols),
  domain = ordered(as.factor(MapDataTable$LaborRatioRounded)),
  reverse = TRUE
)
