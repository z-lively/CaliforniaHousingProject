...
California county subdivisions with the change in employed workers per permit issued from 2009-2019. 
              ...
              popup = ifelse(MapDataTable$LaborRatio >= 0,
                             paste0(MapDataTable$County.Name, 
                                    ...
                                    prettyNum(round(MapDataTable$LaborRatio,2),
                                              big.mark = ","),
                                    " workers for every housing permit issued from 2009 to 2019.",
                                    "<br/>",
                                    "<br/>",
                                    "Workers Gained: ", 
...
Workers per permit ratio for each county. Counties are ordered from slowest worker growth (left side) to fastest worker growth (right side). Data is from 2009-2019. Analysis only shows counties that grew in workers from 2009-2019.
...
# **Rent Increased More in Counties Where Workforce Growth Outnumbered Permits Issued**

Rent change for counties grouped by Workers:Permits < 1:1 (permits outnumbered workers) and Workers:Permits > 1:1 (workers outnumbered permits). Data is from 2009-2019. Analysis only shows counties that grew in workers from 2009-2019.
...
# **Cost of Buying Home Increased More in Counties Where Workforce Growth Outnumbered Permits Issued**

Change in cost of buying home for counties grouped by Workers:Permits < 1:1 (permits outnumbered workers) and Workers:Permits > 1:1 (workers outnumbered permits). Data is from 2009-2019. Analysis only shows counties that grew in workers from 2009-2019.
...
# **Latino Homeownership Grew Slower in Counties Where Workforce Growth Outnumbered Permits Issued**

Homeowner growth for counties grouped by Workers:Permits < 1:1 (permits outnumbered workers) and Workers:Permits > 1:1 (workers outnumbered permits). Data is from 2009-2019. Analysis only shows counties that grew in workers from 2009-2019.
...
OwnerChangesSummary <- OwnerChangesMelt %>%
  filter(County.Name != 'Alpine County' & County.Name != 'Mono County') %>%
  group_by(TileSplit, TileSplitInteractive, variable) %>%
  summarize(AvgChange = mean(value))
