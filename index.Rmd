...
```{r Labor Force Map, echo = FALSE, warning = FALSE, message = FALSE, fig.width=5, fig.height=7}
...
ggplot(RentChangesSummary, aes(x = as.factor(TileSplit), y = AvgChange)) +
...
ggplot(HouseChangesSummary, aes(x = as.factor(TileSplit), y = AvgChange)) +
  geom_bar(aes(fill = as.factor(TileSplit)), 
           stat = 'identity', 
           color = 'black',
           size = 1) +
