...
# **Change in Labor Force Size Per Permit by County**

California county subdivisions with the change in labor force size (workers) per permit issued from 2009-2019. Labor force size includes employed and unemployed people.
...
Workers per permit ratio for each county. Counties are ordered from slowest worker growth (left side) to fastest worker growth (right side). Data is from 2009-2019. Analysis only shows counties that grew in workforce from 2009-2019.

```{r Growth Speed, echo = FALSE, warning = FALSE, message = FALSE}
...
ggplot(LaborGrowth, aes(x = as.factor(LaborGrowthRank), y = LaborRatio)) +
  geom_bar(aes(fill = as.factor(TileSplit)), 
           stat = 'identity', 
           color = 'black',
           size = 1) +
  labs(title = "Workers Per Permit by\nCounty's Rank in Worker Growth",
  ...
  scale_fill_manual(name = NULL,
                    ...
                    values = c(col1, col2)) +
  scale_x_discrete(breaks=c("6","28"),
...
Rent change for counties grouped by Workers:Permits < 1:1 (permits outnumbered workers) and Workers:Permits > 1:1 (workers outnumbered permits). Data is from 2009-2019. Analysis only shows counties that grew in workforce from 2009-2019.

```{r Workers Permits and Rent, echo = FALSE, warning = FALSE, message = FALSE}
...
Change in cost of buying home for counties grouped by Workers:Permits < 1:1 (permits outnumbered workers) and Workers:Permits > 1:1 (workers outnumbered permits). Data is from 2009-2019. Analysis only shows counties that grew in workforce from 2009-2019.

```{r Workers Permits and House, echo = FALSE, warning = FALSE, message = FALSE}
...
# **Black and Latino Homeownership Grew Slower in Counties Where Workforce Growth Outnumbered Permits Issued**

Homeowner growth for counties grouped by Workers:Permits < 1:1 (permits outnumbered workers) and Workers:Permits > 1:1 (workers outnumbered permits). Data is from 2009-2019. Analysis only shows counties that grew in workforce from 2009-2019.

```{r Home Owners, echo = FALSE, warning = FALSE, message = FALSE}
